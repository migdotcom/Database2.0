...
./sort "input=input11.txt;output=output11.txt;command=command11.txt" 1>1.stdcout 2>1.stderr
...
# For test case 2
./sort "input=input12.txt;output=output12.txt;command=command12.txt" 1>1.stdcout 2>1.stderr
...
# For test case 3
./sort "input=input13.txt;output=output13.txt;command=command13.txt" 1>1.stdcout 2>1.stderr
